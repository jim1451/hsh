...
import com.silence.commonframe.utils.Engine;
...
public class App extends Application {
    ...
    public    static List<Activity> oList;//用于存放所有启动的Activity的集合
...
//                })
    ...
    private void initSharedPre(String str) {
