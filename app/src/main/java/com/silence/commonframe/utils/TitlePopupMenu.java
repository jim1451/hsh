...
public class TitlePopupMenu extends PopupWindow {
     ...
     **/
    private static final int DF_POPUP_WINDOW_BACKGROUND_COLOR = 0xFFFFFF;   //0xFFFFFF 0xBB000000  0xF8F8FF
    ...
    public TitlePopupMenu(Context context, int width, int height) {
        ...
        mListDividerHeight = (int) (DF_POPUP_WINDOW_DIVIDER_HEIGHT * dm.density + 0.3f);
