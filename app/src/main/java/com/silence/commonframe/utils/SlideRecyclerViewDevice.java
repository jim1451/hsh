...
public class SlideRecyclerViewDevice extends RecyclerView {
    ...
    public SlideRecyclerViewDevice(Context context) {
        this(context, null);
    }

    public SlideRecyclerViewDevice(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideRecyclerViewDevice(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                MyAdapterSlideSite.MyViewHolder viewHolder = (MyAdapterSlideSite.MyViewHolder) getChildViewHolder(view);
