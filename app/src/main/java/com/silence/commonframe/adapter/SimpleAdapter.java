...
import com.silence.commonframe.utils.DensityUtil;

import java.util.List;

public class SimpleAdapter extends BaseRecyclerAdapter<SimpleAdapter.SimpleAdapterViewHolder> {
    private List<Person1> list;
    private int largeCardHeight, smallCardHeight;

    public SimpleAdapter(List<Person1> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(SimpleAdapterViewHolder holder, int position, boolean isItem) {
        Person1 person = list.get(position);
    ...
    public void setData(List<Person1> list) {
        this.list = list;
    ...
    public void insert(Person1 person, int position) {
        ...
        public SimpleAdapterViewHolder(View itemView, boolean isItem) {
            ...
            if (isItem) {
                ...
                ageTv = (TextView) itemView
                        .findViewById(R.id.recycler_view_place);
                rootView = itemView
    ...
    public Person1 getItem(int position) {
