...
public class RecViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   // private MainActivity mainActivity;
    ...
    public RecViewAdapter(Context mainActivity, List<String> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        if (viewViewHolder != null) {
         //   viewViewHolder.titel.setText( "海智园3栋" +list.get(position) + ""+"...");
            viewViewHolder.titel.setText( list.get(position).toString());
            ///////////////////////////////////點擊變色/////////////////////////////////////////////
            if (position == getthisPosition()) {
                //選中的顔色就設成了  黃色
              //  viewViewHolder.titel.setBackgroundColor(Color.LTGRAY);//LTGRAY
              //  viewViewHolder.titel.setBackgroundColor(Color.GRAY);//LTGRAY
                viewViewHolder.titel.setBackgroundColor(Color.parseColor("#CCCCCC"));
            } else {
                //未選中的顔色 就設成了 白色

                viewViewHolder.titel.setBackgroundColor(Color.WHITE);//LTGRAY
            }
            ////////////////////////////////////點擊變色////////////////////////////////////////////
        }
        /**
...
//        }
    ...
    class RecViewViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecViewViewHolder(View itemView) {
            super(itemView);
            titel = (TextView) itemView.findViewById(R.id.item_titel);
        }
    }
}
