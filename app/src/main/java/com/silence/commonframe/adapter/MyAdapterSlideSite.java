...
public class MyAdapterSlideSite extends RecyclerView.Adapter {
    ...
    public MyAdapterSlideSite(Context context, List<HashMap<String, String>> listmap) {
        mContext = context;
    ...
    public MyAdapterSlideSite(Context context, ArrayList<String> list) {
        mContext = context;
        mInflater = LayoutInflater.from(context);
        mList = list;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(mInflater.inflate(R.layout.recyclerview_item_layoutsite, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        viewHolder.name.setText("设备名称："+listmap1.get(position).get("name"));
