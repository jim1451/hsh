...
import com.silence.commonframe.adapter.listViewAdapter1;
...
public class DeviceActivity extends AppCompatActivity {
    ...
    private listViewAdapter1 findAdapter;
    ...
    private Handler handler = new Handler()
    {
        public void handleMessage(Message msg)
        {
            ...
            {
                case 123:
                    adapter = new listViewAdapter1(DeviceActivity.this, list);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener()
        {
            ...
            public boolean onQueryTextSubmit(String query)
            {
                ...
                {
                    Toast.makeText(DeviceActivity.this, "请输入查找内容！", Toast.LENGTH_SHORT).show();
                    listView.setAdapter(adapter);
                }
                else
                {
                    ...
                    if(findList.size() == 0)
                    {
                        Toast.makeText(DeviceActivity.this, "查找的商品不在列表中", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        Toast.makeText(DeviceActivity.this, "查找成功", Toast.LENGTH_SHORT).show();
                        findAdapter = new listViewAdapter1(DeviceActivity.this, findList);
...
//                bitmap = BitmapFactory.decodeResource(DeviceActivity.this.getResources(), R.mipmap.table);
//                iconInfo44.setName("Table");
//                iconInfo44.setIcon(bitmap);
//                list.add(iconInfo44);
//                iconInformation iconInfo45 = new iconInformation();
//                bitmap = BitmapFactory.decodeResource(DeviceActivity.this.getResources(), R.mipmap.teacup);
//                iconInfo45.setName("Tea-Cup");
//                iconInfo45.setIcon(bitmap);
//                list.add(iconInfo45);
//                iconInformation iconInfo46 = new iconInformation();
//                bitmap = BitmapFactory.decodeResource(DeviceActivity.this.getResources(), R.mipmap.terrace);
//                iconInfo46.setName("Terrace");
//                iconInfo46.setIcon(bitmap);
//                list.add(iconInfo46);
//                iconInformation iconInfo47 = new iconInformation();
//                bitmap = BitmapFactory.decodeResource(DeviceActivity.this.getResources(), R.mipmap.tray1);
//                iconInfo47.setName("Tray1");
//                iconInfo47.setIcon(bitmap);
//                list.add(iconInfo47);
//                iconInformation iconInfo48 = new iconInformation();
//                bitmap = BitmapFactory.decodeResource(DeviceActivity.this.getResources(), R.mipmap.tray);
//                iconInfo48.setName("Tray");
//                iconInfo48.setIcon(bitmap);
//                list.add(iconInfo48);
//                iconInformation iconInfo49 = new iconInformation();
//                bitmap = BitmapFactory.decodeResource(DeviceActivity.this.getResources(), R.mipmap.vegetables);
//                iconInfo49.setName("Vegetables");
//                iconInfo49.setIcon(bitmap);
//                list.add(iconInfo49);
 //               iconInformation iconInfo50 = new iconInformation();
//                bitmap = BitmapFactory.decodeResource(DeviceActivity.this.getResources(), R.mipmap.wine);
